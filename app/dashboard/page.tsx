...
export default async function DashboardPage() {
  ...
  const stats = [
    { label: "Enrolled Courses", value: enrollments.length, icon: BookOpen, color: "from-purple-500 to-indigo-500" },
    ...
    { label: "Certificates", value: 0, icon: Star, color: "from-pink-500 to-rose-500" },
  ];
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/dashboard/my-learning" className="text-sm text-purple-600 hover:underline">View all</Link>
            </div>
            {enrollments.length === 0 ? (
              <div className="bg-white rounded-2xl border border-gray-100 p-8 text-center">
                <BookOpen className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                <p className="text-gray-500 mb-4">You haven't enrolled in any courses yet.</p>
                <Link href="/courses" className="px-6 py-2.5 bg-purple-600 text-white font-semibold rounded-xl hover:bg-purple-700 transition-colors">
                  Browse Courses
                </Link>
              </div>
            ) : (
                ...
                {enrollments.map((enrollment) => {
                  ...
                  return (
                    <div key={enrollment.id} className="bg-white rounded-2xl border border-gray-100 p-4 flex gap-4 hover:shadow-md transition-shadow">
                      <div className="w-24 h-16 rounded-xl bg-gradient-to-br from-purple-100 to-indigo-100 flex items-center justify-center shrink-0 overflow-hidden">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <Link href={`/courses/${enrollment.course.slug}/learn`} className="flex items-center gap-1 text-xs font-semibold text-purple-600 hover:text-purple-700">
