    ...
    <div className="relative w-full h-full bg-black group">
      ...
      <div className="absolute inset-0 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-t from-black/70 to-transparent">
        ...
        <div className="flex items-center gap-4 px-4 pb-4">
          <button onClick={() => setPlaying(!playing)} className="text-white hover:text-amber-300 transition-colors">
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setMuted(!muted)} className="text-white hover:text-amber-300 transition-colors">
